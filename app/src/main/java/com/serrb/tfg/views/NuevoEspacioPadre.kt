...
@Composable
fun NuevoEspacioPadre(navController: NavHostController, id:Long?){
        ...
        LazyColumn(
            ...
            item {
                Button(
                    ...
                    Text(
                        text = selectedCategoria?.nombre ?: "Casa",
            ...
            val espacio = Espacio(null,nombre,id!!,10)
            ...
            item {
                ...
                if (mensaje.isNotEmpty()) {
                    StartDialogAct4(navController, mensaje, viewModel) { showDialog2 = false }
                ...
                datosValidos = ValidaDatosEspacioPadre(espacio.nombre)
...
@Composable
fun ValidaDatosEspacioPadre (nombre:String): Boolean {
    val viewModel: EspaciosViewModel = viewModel()
    ...
    if (nombre.isNotEmpty()){
        if(nombre.length < 20 && nombre.matches("[a-zA-Z0-9]+".toRegex())) {
            nombreIsValido = true
...
@Composable
fun StartDialogAct4(navController: NavController, mensaje: String, viewModel: EspaciosViewModel, onDismiss: () -> Unit) {
